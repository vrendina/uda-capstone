...
public class QuoteFormLeaseFragment extends Fragment {
    ...
    public void testClicked() {
        ValueAnimator anim = ValueAnimator.ofInt(scrollView.getMeasuredHeight(), scrollView.getMeasuredHeight() - 400);
